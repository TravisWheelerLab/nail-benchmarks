...
.PHONY: hmmer
hmmer:
	@echo TODO: retrieve/build hmmer
	@False	
...
mmseqs:
	...
	@rm $(MMSEQS_BIN_TGZ)
	@ln -sf $(realpath $(MMSEQS_BIN)) $(MMSEQS)
...
BLAST_BIN     := $(BLAST_BIN_DIR)/bin/blastp
.PHONY: blast
blast:
